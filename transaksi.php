...
$id = $_GET["id"];
$data = query("SELECT * FROM tbpaketcuci where idpaket= $id")[0];
$harga = $data["harga"];
...
?>
        ...
        <div class="card m-5 p-4">
            <form action="" method="post">
                <input type="hidden" name="idpaketcuci" value="<?= $data["idpaket"] ?>">
                <div class="row">
                    <div class="col-md-8">
                        <div class="mb-3 row">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col">
                            <input type="text" class="form-control" name="username" value="" id="input3">
                            </div>
                        </div>
                        <div class="mb-3 row">
            ...
            <div class="col-6 px-5">
                ...
                <button type="submit" name="tambah" class="btn btn-primary mt-5" data-bs-toggle="modal" data-bs-target="#staticBackdrop">
                    Simpan Transaksi
                </button>
            </form>
